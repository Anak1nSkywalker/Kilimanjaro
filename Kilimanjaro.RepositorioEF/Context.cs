...
namespace Kilimanjaro.RepositoryEF
{
    public class Context : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Vehicle>().Property(vehicle => vehicle.Weight).IsRequired().HasColumnType("decimal");
            modelBuilder.Entity<Vehicle>().Property(vehicle => vehicle.Height).IsRequired().HasColumnType("decimal");
            modelBuilder.Entity<Vehicle>().Property(vehicle => vehicle.Width).IsRequired().HasColumnType("decimal");
            modelBuilder.Entity<Vehicle>().Property(vehicle => vehicle.Length).IsRequired().HasColumnType("decimal");            
            modelBuilder.Entity<Vehicle>().Property(vehicle => vehicle.UsefulAreaHeight).HasColumnType("decimal");
            modelBuilder.Entity<Vehicle>().Property(vehicle => vehicle.UsefulAreaWidth).HasColumnType("decimal");
            modelBuilder.Entity<Vehicle>().Property(vehicle => vehicle.UsefulAreaLength).HasColumnType("decimal");
